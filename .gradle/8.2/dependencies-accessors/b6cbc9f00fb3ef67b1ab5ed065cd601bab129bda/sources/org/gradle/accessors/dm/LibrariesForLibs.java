...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinLibraryAccessors extends SubDependencyFactory {
        ...
        public KotlinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for logger (io.github.oshai:kotlin-logging-jvm)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getLogger() {
                return create("kotlin.logger");
        }
    ...
    public static class KotlinVersionAccessors extends VersionFactory  {
        ...
        public KotlinVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: kotlin.logger (5.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getLogger() { return getVersion("kotlin.logger"); }
